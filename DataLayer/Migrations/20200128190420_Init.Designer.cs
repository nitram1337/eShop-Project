            ...
            modelBuilder.Entity("DataLayer.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            DatePlaced = new DateTime(2020, 1, 28, 20, 4, 20, 425, DateTimeKind.Local).AddTicks(834),
                            DeliveryId = 1,
                            PaymentId = 2,
                            TotalPrice = 2920000m
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            DatePlaced = new DateTime(2020, 1, 28, 20, 4, 20, 427, DateTimeKind.Local).AddTicks(4243),
                            DeliveryId = 2,
                            PaymentId = 3,
                            TotalPrice = 1364000m
                        });
