...
namespace DataLayer.Migrations
{
    ...
    [Migration("20191017192932_DBchange")]
            ...
            modelBuilder.Entity("DataLayer.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            DatePlaced = new DateTime(2019, 10, 17, 21, 29, 30, 712, DateTimeKind.Local).AddTicks(4732),
                            DeliveryId = 1,
                            PaymentId = 2,
                            TotalPrice = 2920000m
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            DatePlaced = new DateTime(2019, 10, 17, 21, 29, 30, 717, DateTimeKind.Local).AddTicks(9130),
                            DeliveryId = 2,
                            PaymentId = 3,
                            TotalPrice = 1364000m
                        });
