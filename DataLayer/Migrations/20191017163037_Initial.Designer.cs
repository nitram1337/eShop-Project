...
namespace DataLayer.Migrations
{
    ...
    [Migration("20191017163037_Initial")]
            ...
            modelBuilder.Entity("DataLayer.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            DatePlaced = new DateTime(2019, 10, 17, 18, 30, 37, 98, DateTimeKind.Local).AddTicks(8949),
                            DeliveryId = 1,
                            PaymentId = 2,
                            TotalPrice = 2920m
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            DatePlaced = new DateTime(2019, 10, 17, 18, 30, 37, 101, DateTimeKind.Local).AddTicks(5796),
                            DeliveryId = 2,
                            PaymentId = 3,
                            TotalPrice = 1364m
                        });
