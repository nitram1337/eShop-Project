...
namespace DataLayer.Migrations
{
    ...
    [Migration("20191103151707_TilføjetDbsets")]
    partial class TilføjetDbsets
    {
            ...
            modelBuilder.Entity("DataLayer.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            DatePlaced = new DateTime(2019, 11, 3, 16, 17, 6, 385, DateTimeKind.Local).AddTicks(7765),
                            DeliveryId = 1,
                            PaymentId = 2,
                            TotalPrice = 2920000m
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            DatePlaced = new DateTime(2019, 11, 3, 16, 17, 6, 390, DateTimeKind.Local).AddTicks(4361),
                            DeliveryId = 2,
                            PaymentId = 3,
                            TotalPrice = 1364000m
                        });
